...
public class HttpClient {
    ...
    public static HttpResult get(String url) {
        return getWithHeaders(url, null, DEFAULT_TIMEOUT);
    }
    ...
    public static HttpResult getWithAuthorize(String url, String header) {
        return getWithAuthorize(url, header, DEFAULT_TIMEOUT);
    }
    ...
    public static HttpResult getWithHeaders(String url, Map<String, String> headers) {
        return getWithHeaders(url, headers, DEFAULT_TIMEOUT);
    }
    ...
    public static HttpResult post(String url, String param) {
        return postWithHeaders(url, param, null, DEFAULT_TIMEOUT);
    }
    ...
    public static HttpResult postWithAuthorize(String url, String param, String header) {
        return postWithAuthorize(url, param, header, DEFAULT_TIMEOUT);
    }
    ...
    public static HttpResult postWithHeaders(String url, String param, Map<String, String> headers, int timeout) {
        ...
        if (!headers.containsKey("Content-Type")) headers.put("Content-Type", "application/x-www-form-urlencoded");
...
//            log.info("{}", result.getData().toString());
    ...
    public static HttpResult deleteWithAuthorize(String url, String param, String header, int timeout) {
        Map<String, String> headers = new HashMap<String, String>();
        headers.put("Authorization", header);
        return deleteWithHeaders(url, param, headers, timeout);
    }

    public static HttpResult deleteWithHeaders(String url, String param, Map<String, String> headers) {
        return deleteWithHeaders(url, param, headers, 1000);
    }

    public static HttpResult deleteWithHeaders(String url, String param, Map<String, String> headers, int timeout) {
